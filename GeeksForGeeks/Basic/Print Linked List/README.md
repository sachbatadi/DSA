...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/print-linked-list-elements/1)

## Solved On
09 Sept 2026 at 02:17 pm

<h2><a href="https://www.geeksforgeeks.org/problems/print-linked-list-elements/1">Print Linked List</a></h2><h3>Difficulty Level: Basic</h3><hr><p><span style="font-size: 18px;">You are given the head of a singly <strong>linked list</strong>. Return an <strong>array</strong> containing the values of the nodes.</span></p>
...
<div><span style="font-size: 18px;">1 ≤ node values ≤ 10<sup>6</sup></span></div>